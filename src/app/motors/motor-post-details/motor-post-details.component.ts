...
@Component({
    selector: 'app-motor-post-details',
    templateUrl: './motor-post-details.component.html',
    styleUrls: ['./motor-post-details.component.scss'],
    standalone: false
})
export class MotorPostDetailsComponent implements OnInit {
  params: any;
  getPostData:any;
  postId:any;
  ...
  approve(value){
    ...
    this.authService.approveMotorPost(object,postId)
     .subscribe((res: any) => {
       if (res.success == true) {
